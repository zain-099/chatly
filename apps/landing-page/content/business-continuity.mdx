...
- 👤 Led by [Abdelrahman Abdelazeiz](https://www.linkedin.com/in/abdelrahman-abdelazeiz), with support from part-time collaborators
...
As the founder, Chatly is my full-time, long-term focus. I've been working on it for a long time with no plans to stop. My goal is to build a sustainable, reliable product. Not pursue rapid exits or risky pivots.
...
I’d be happy to provide them. Book an Enterprise plan meeting with me [here](https://Chatly.io/enterprise-lead-form).

Abdelrahman Abdelazeiz,<br />Founder of Chatly
