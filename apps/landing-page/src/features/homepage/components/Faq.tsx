...
const data = [
  {
    ...
    content: (
      <>
        Chatly offers flexible pricing plans to suit solo business owners,
        startups, and large companies. The{" "}
        <span className="font-bold">Free</span> plan includes unlimited
        chatbots, 200 chats per month, native integrations, webhooks, custom
  ...
  {
    title:
      "How easy is it to integrate Chatly with my existing systems and platforms?",
    content: (
      <>
        Integrating Chatly with your existing systems and platforms is
        straightforward. We provide clear, step-by-step instructions to guide
        you through the process. Chatly supports a wide range of platforms,
  ...
  {
    title:
      "What kind of AI and machine learning capabilities does Chatly offer?",
    content: (
      <>
        Chatly is AI provider agnostic, giving you the flexibility to connect
        with any AI provider of your choice. Unlike competitors that lock you
        into proprietary systems, Chatly provides the building blocks to
  ...
  },
  {
    ...
    content: (
      <>
        If you encounter any issues or need assistance, Chatly offers several
  ...
  {
    title: "How secure is Chatly, and how do you handle data privacy?",
    content: (
      <p>
        Chatly is ISO 27001 certified, demonstrating our commitment to
