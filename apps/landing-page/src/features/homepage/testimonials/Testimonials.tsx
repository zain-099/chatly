...
const testimonials = [
  {
    ...
    content: (
      <>
        ...
        answers (user industry and role) given in the chatbot. We are big fan!
      </>
    ),
  },
  {
    ...
    content: (
      <>
        I used Chatly at my company and was impressed with how it cut our
  ...
  },
  {
    ...
    content: (
      <>
        I have several chatbot builders, but Chatly is the one I use the most.
  ...
  },
  {
    ...
    content: (
      <>
        Chatly is one of the best chatbot builders with its intelligent features
        and drag-and-drop simplicity. Its UI/UX is an earthly paradise...
        <br />
  ...
  },
  {
    ...
    content:
      "Within 5 minutes of signing up you can already have your bot running thanks to the templates it comes with. I have used many tools to make bots but none as simple, easy and powerful as Chatly.",
  },
  {
    name: "Julien Muratot",
    ...
    provider: "email",
    content:
      "I run Google ads all year long on our landing page that contains a chatbot. I saw a 2x increase on our conversation rate compared to our old WordPress form.",
  },
  {
    name: "Joshua Lim",
    ...
    provider: "email",
    content:
      "I upgraded my typeforms to chatbots and saw a conversion rate increase from 14% to 43% on my marketing campaigns. I noticed the improvement on day one. That was a game-changer.",
  },
  {
    name: "Mario Barretta",
    ...
    content: (
      <>
        Thanks to Chatly I can finally make site forms much more modern and I
        can collect information that I would have missed before. Also ,thanks to
        Abdelrahman zain, the service is always evolving and has excellent assistance
  ...
  },
  {
    ...
    content: (
      <>
        Amazing product! I&apos;m using Chatly for everything when it&apos;s
        about talking with customers.
        <br />
        <br />
        What&apos;s amazing with Chatly is that it makes a &quot;chat interface
  ...
  },
  {
    ...
    provider: "email",
    content:
      "I am really loving using Chatly! So good. I have used all the top bots and yours is definitely the most user friendly, and yet still so powerful.",
  },
  {
    name: "Lucas Barp",
    provider: "email",
  ...
  },
  {
    ...
    content:
      "Using this tool for the last 2 hours & built a full lead capture bot. Pretty good experience till now. @AbdelrahmanZain All the best for future :)",
  },
  {
    name: "Anna Filou",
    provider: "productHunt",
