...
const useCases = [
  {
    ...
    images: {
      builder: {
        ...
        alt: "An example of a marketing bot being built in Chatly",
      },
      bot: {
        src: marketingBotSrc,
  ...
  },
  {
    ...
    images: {
      builder: {
        ...
        alt: "An example of a support bot being built in Chatly",
      },
      bot: {
  ...
  },
  {
    ...
    images: {
      builder: {
        src: salesBuilderSrc,
        alt: "An example of a sales bot being built in Chatly",
      },
      bot: {
        src: salesBotSrc,
