...
export const Route = createFileRoute("/_layout/blog/")({
  head: () => ({
    meta: createMetaTags({
      title: "Chatly Blog",
      description:
        "Learn more about Chatly, chatbots, conversational AI and more to help you hack the bot game and grow your business.",
  ...
  return (
    <ContentPageWrapper className="max-w-3xl">
      <div className="flex flex-col gap-6">
        ...
        <p className="text-xl">
          Learn more about Chatly, chatbots, conversational AI and more to help
