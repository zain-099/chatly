...
export const Route = createFileRoute("/_layout/about")({
  head: () => ({
    meta: createMetaTags({
      title: "About | Chatly",
      description:
        "Chatly empowers businesses to craft personalized, interactive experiences that foster deeper connections with users.",
    ...
    <ContentPageWrapper>
      <div className="max-w-3xl mx-auto gap-16 flex flex-col">
        ...
        <div className="flex flex-col gap-10 font-display text-3xl md:text-justify">
          ...
          <p>
            I'm Abdelrahman Zain, a software engineer passionate about user experience
            and design.
          </p>
          <p className="font-bold">
            That's why I created Chatly—to unlock the full potential of chatbots
            and make them intuitive, beautiful, and impactful.
          </p>
          <p>Let's bot!</p>
        </div>
      </div>
