...
This will set your variable with either `desktop`, `tablet` or `mobile` depending on the device type. Under the hood, we uses a combination screen width, user agent and touch capabilities to detect the device type. You can find the code [here](https://github.com/zain-099/blob/e74b95fd65064b7e1c37f7fb789c316deb601d36/packages/bot-engine/src/blocks/logic/setVariable/executeSetVariable.ts#L322-L350)
