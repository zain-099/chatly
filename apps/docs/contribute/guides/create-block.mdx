...
<Note>
  ...
  issue](https://github.com/zain-099/issues/new) first. This will
...
Make sure to check out other blocks implementations in the [packages/forge/blocks](https://github.com/zain-099/tree/main/packages/forge/blocks) folder.
