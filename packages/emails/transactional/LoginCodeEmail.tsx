...
export const LoginCodeEmail = ({ url, code }: Props) => (
  <Html>
    <Head />
    <Preview>Your login code for Chatly</Preview>
    <Body style={main}>
      <Container style={container}>
        <Logo />
        <Heading style={heading}>Your login code for Chatly</Heading>
        ...
        <Hr style={hr} />
        <Text style={footerText}>Chatly - Build faster, Chat smarter</Text>
      </Container>
    </Body>
  </Html>
);
